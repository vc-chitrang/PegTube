...
namespace UnityEditor.UI {
	...
	public class ProceduralImageEditor : ImageEditor {
		...
		SerializedProperty m_gradientReverse;
		int selectedId;
		...
		protected override void OnEnable() {
			...
			m_topColor = serializedObject.FindProperty("topColor");
			m_bottomColor = serializedObject.FindProperty("bottomColor");
			m_gradientReverse = serializedObject.FindProperty("reverseGradient");
