...
namespace ViitorCloud.GameHelper.GoKit {
	public class GoTweenConfig {
		...
		/// position path tween
		/// </summary>
		public GoTweenConfig positionPath(GoSpline path, bool isRelative = false, GoLookAtType lookAtType = GoLookAtType.None, Transform lookTarget = null, bool useLocalPosition = false) {
			var prop = new PositionPathTweenProperty(path, isRelative, useLocalPosition, lookAtType, lookTarget);
			_tweenProperties.Add(prop);
		...
		/// <summary>
		/// generic animation curve tween
		/// </summary>
		public GoTweenConfig animationCurveProp(string propertyName, float endValue, AnimationCurve curve, bool isRelative = false) {
			var prop = new AnimationCurveTweenProperty(propertyName, endValue, curve, isRelative);
			_tweenProperties.Add(prop);
		...
		/// <summary>
		/// sets the number of iterations. setting to -1 will NOT loop infinitely (BUG)
		/// </summary>
		...
		/// <summary>
		/// sets the number of iterations and the loop type. setting to -1 will NOT loop infinitely (BUG)
		/// </summary>
